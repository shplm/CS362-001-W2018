...
public class Appt implements  Comparable<Appt>{
	...
	if(startHour<0 || startHour>23)// I do fix here, the comment line below is my buggy code
    ...
    private String represntationApp(){
       String half = (getStartHour() > 11) ? "pm" : "am"; // I do fix here, the comment line below is my buggy code
